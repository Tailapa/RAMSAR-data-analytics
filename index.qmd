...
<iframe 
  ...
  width="100%" 
  style="border:none; width:100%; height: 2250px; overflow:hidden;" 
  frameborder="0" 
  scrolling="no">>
...
<iframe 
  src="methods.html" 
  width="100%" 
  style="border:none; width:100%; height: 1520px; overflow:hidden;" 
  frameborder="0" 
  scrolling="no">>
...
<iframe 
  ...
  width="100%" 
  style="border:none; width:100%; height: 1580px; overflow:hidden;" 
  frameborder="0" 
  scrolling="no">
</iframe>
```
...
<iframe 
    src="recoms.html" 
    width="100%" 
    style="border:none; width:100%; height: 2500px; overflow:hidden;" 
    frameborder="0" 
    scrolling="no">
</iframe>
```
...
<iframe 
    src="conclusion.html" 
    width="100%" 
    style="border:none; min-height: 85vh; width:100%;" 
    frameborder="0" 
    scrolling="no">
</iframe>

<script>
  var iframe = document.getElementById('recoms-frame');
  
  // This function executes the "Geometric Expansion"
  function resizeIframe() {
    if (iframe && iframe.contentWindow.document.body) {
      // Adding a 100px buffer ensures the "Learning from Best Practices" section is fully visible
      var newHeight = iframe.contentWindow.document.body.scrollHeight + 100;
      iframe.style.height = newHeight + 'px';
    }
  }

  // Trigger resize on load and on every window change
