...
```{=html}
<iframe src="executive_summary.html" width="100%" height="800px" frameborder="0"></iframe>
```

```{=html}
<iframe src="key_findings.html" width="100%" height="800px" frameborder="0"></iframe>
```
...
```{=html}
<iframe src="methods.html" width="100%" height="800px" frameborder="0"></iframe>
```
...
```{=html}
<iframe src="red_list_report.html" width="100%" height="800px" frameborder="0"></iframe>
```

::: {style="display: none;"}
## [Actionable Policy Recommendations](red_list_report.html#policy-recommendations)

## [Conclusion](red_list_report.html#final-conclusion)
:::
